    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <?php if (Yii::$app->user->isGuest) : ?>
                <?= Html::a('Sign in', ['/user/security/login'], ['class' => 'nav-link']) ?>
            <?php else : ?>
                <?= Html::a('Sign out (' . Yii::$app->user->identity->username . ')', ['/user/security/logout'], ['class' => 'nav-link', 'data-method' => 'post']) ?>
            <?php endif; ?>
        </li>

        <li class="nav-item">
            <?= Html::a('Register', ['/user/registration/register'], ['class' => 'nav-link', 'visible' => Yii::$app->user->isGuest]) ?>
        </li>
